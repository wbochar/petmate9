...
import styles from './ShaderSelector.module.css'
...
function ShaderSelectorView(props: {
  font: Font;
  charset: string;
  customFonts: cfonts.CustomFonts;
  canvasScale: {
  ...
  fb: Pixel[][];
  onShaderSelectored: (pos: Coord2|null) => void;
  ...
  let handleOnClick = useCallback(function() {
    props.onShaderSelectored(charPos);
...
class ShaderSelector extends Component<ShaderSelectorProps> {

  fb: Pixel[][]|null = null;
  font: Font|null = null;
  prevTextColor = -1;

  constructor (props: ShaderSelectorProps) {
    super(props)
  ...
  render () {
    ...
    return (
      <ShaderSelectorView
        ...
        onShaderSelectored={this.handleClick}
